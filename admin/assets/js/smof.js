...
$.browser = browser;
    ...
    //Add new extended slide
    $("body").on('click','.extended_slide_add_button', function(){
        var slidesContainer = $(this).prev();
        var sliderId = slidesContainer.attr('id');
        ...
        var newSlide = '<li class="temphide"><div class="slide_header"><strong>Slide ' + newNum + '</strong><input type="hidden" class="slide of-input order" name="' + sliderId + '[' + newNum + '][order]" id="' + sliderId + '_slide_order-' + newNum + '" value="' + newNum + '"><a class="slide_edit_button" href="#">Edit</a></div><div class="slide_body" style="display: none; "><label>Image URL</label><input class="slide of-input" name="' + sliderId + '[' + newNum + '][url]" id="' + sliderId + '_' + newNum + '_slide_url" value=""><div class="upload_button_div"><span class="button media_upload_button" id="' + sliderId + '_' + newNum + '" rel="'+sliderInt+'">Upload</span><span class="button mlu_remove_button hide" id="reset_' + sliderId + '_' + newNum + '" title="' + sliderId + '_' + newNum + '">Remove</span></div><div class="screenshot"></div><label>Text Heading</label><input class="slide of-input" name="' + sliderId + '[' + newNum + '][text_heading]" id="' + sliderId + '_' + newNum + '_slide_text_heading" value=""><label>Text Highlighted</label><input class="slide of-input" name="' + sliderId + '[' + newNum + '][text_highlighted]" id="' + sliderId + '_' + newNum + '_slide_text_highlighted" value=""><label>Text Normal</label><input class="slide of-input" name="' + sliderId + '[' + newNum + '][text_normal]" id="' + sliderId + '_' + newNum + '_slide_text_normal" value=""><label>Text Color</label><select class="slide of-input" name="' + sliderId + '[' + newNum + '][text_color]" id="' + sliderId + '_' + newNum + '_slide_text_color" value=""><option id="light" value="Light">Light</option><option id="dark" value="Dark">Dark</option></select><label>Button Name</label><input class="slide of-input" name="' + sliderId + '[' + newNum + '][button_name]" id="' + sliderId + '_' + newNum + '_slide_button_name" value=""><label>Button URL</label><input class="slide of-input" name="' + sliderId + '[' + newNum + '][button_url]" id="' + sliderId + '_' + newNum + '_slide_button_url" value=""><a class="slide_delete_button" href="#">Delete</a><div class="clear"></div></div></li>';
    ...
    //Add new text slide
    $("body").on('click','.text_slide_add_button', function(){
        var slidesContainer = $(this).prev();
        var sliderId = slidesContainer.attr('id');
        var sliderInt = $('#'+sliderId).attr('rel');
        ...
        var newSlide = '<li class="temphide"><div class="slide_header"><strong>Slide ' + newNum + '</strong><input type="hidden" class="slide of-input order" name="' + sliderId + '[' + newNum + '][order]" id="' + sliderId + '_slide_order-' + newNum + '" value="' + newNum + '"><a class="slide_edit_button" href="#">Edit</a></div><div class="slide_body" style="display: none; "><label>Text</label><input class="slide of-input" name="' + sliderId + '[' + newNum + '][text]" id="' + sliderId + '_' + newNum + '_slide_text" value="" /><a class="slide_delete_button" href="#">Delete</a><div class="clear"></div></div></li>';
